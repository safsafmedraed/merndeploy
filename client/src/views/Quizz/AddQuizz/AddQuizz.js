...
class AddQuizz extends Component {
    ...
    axios.get(`/users/userid/${id}`)
      .then(res => {
        ...
        this.state.Classes.forEach(element => {
          ...
          axios.get(`/class/classeid/${element.classe}`)
            .then(res => {
  ...
  onchangeclass(e) {
    ...
    axios.get(`/class/classeid/${classe}`)
      .then(res => {
  ...
  onchangelesson(e) {
    ...
    axios.get(`/Questions/questionbym/${this.state.ll}`)
      .then(res => {
      ...
      .then(res => {
        ...
        if (this.state.Le !== undefined) {
          this.state.Le.forEach(element => {
            ...
            axios.get(`/Lesson/Lesson/${element}`)
              .then(res => {
  ...
  onsubmit(e) {
    ...
    this.state.value.forEach(element => {
      axios.get(`/Questions/questions/${element}`)
        .then(res => {
          console.log(res);
      ...
      axios.post('/Quizz/Quizz', Quizz)
        .then(res => {
          ...
          if (this.state.Module.length === 1) {
            axios.put(`/Lesson/addTo/${this.state.Module}/${res.data._id}`)
            .then(res => {
              console.log("yesss")
            })
          }
          else if (this.state.Module.length > 1) {
            axios.put(`/Lesson/addTo/${this.state.mm}/${res.data._id}`)
            .then(res => {
              console.log("yesss")
            })
          }
          this.state.value1.forEach(element => {
            ...
            axios.put(`/users/Userquizz/${element}/${this.state.idd}`)
              .then(res => {
