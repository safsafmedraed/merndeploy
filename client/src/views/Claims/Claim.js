...
class Claim extends Component {
  constructor(props) {
    ...
    axios.get("/claims/" + props.match.params.id)
      .then(res => {
        ...
        if (props.user) {
          if (res.data.lock === true && res.data.admin._id !== props.user._id) {
            ...
            axios.put("/claims/lock/" + props.match.params.id, { admin: props.user._id })
              .then(() => {
            ...
            <Modal isOpen={this.state.confirmationBlock} toggle={this.toggleDanger}
              ...
              <ModalFooter>
                <Button color="danger" onClick={() => {
                  ...
                  claim.removed = true;
                  axios.put("/claims/block/" + claim._id)
                    .then(() => {
            ...
            <Modal isOpen={this.state.confirmationUnblock} toggle={this.toggleSuccess}
              ...
              <ModalFooter>
                <Button color="success" onClick={() => {
                  ...
                  axios.put("/claims/unlock/" + claim._id)
                    .then(() => {
                      setTimeout(() => {
                        this.props.history.push("/Claims");
                      }, 500);
